...
const italian: Language = {
    ...
    questions: [
        ...
        { id: 4, prompt: "Quando ho chiesto aiuto oggi? Com'è andata?", answers: [] },
        { id: 5, prompt: "Cosa di nuovo ho imparato oggi?", answers: [] },
        { id: 6, prompt: "Qual è una cosa che mi piacerebbe ripetere domani?", answers: [] },
        { id: 7, prompt: "Cosa mi ha fatto ridere oggi?", answers: [] },
        { id: 8, prompt: "Per cosa sono grato(a) oggi?", answers: [] },
        { id: 9, prompt: "Quale ricordo di oggi vorrei che restasse?", answers: [] },
    ],
...
const english: Language = {
    ...
    questions: [
        ...
        { id: 4, prompt: "When did I ask for help today? How did it go?", answers: [] },
        { id: 5, prompt: "What new thing did I learn today?", answers: [] },
        { id: 6, prompt: "What is one thing I’d like to repeat tomorrow?", answers: [] },
        { id: 7, prompt: "What made me laugh today?", answers: [] },
        { id: 8, prompt: "What am I grateful for today?", answers: [] },
        { id: 9, prompt: "Which memory from today would I like to keep?", answers: [] },
    ],
...
const spanish: Language = {
    ...
    questions: [
        ...
        { id: 6, prompt: "¿Qué es una cosa que me gustaría repetir mañana?", answers: [] },
        { id: 7, prompt: "¿Qué me hizo reír hoy?", answers: [] },
        { id: 8, prompt: "¿Por qué estoy agradecido(a) hoy?", answers: [] },
        { id: 9, prompt: "¿Qué recuerdo de hoy me gustaría conservar?", answers: [] },
    ],
...
const french: Language = {
    ...
    questions: [
        ...
        { id: 2, prompt: "Qu’est-ce qui s’est bien passé aujourd’hui ?", answers: [] },
        { id: 3, prompt: "Comment ai-je aidé quelqu’un aujourd’hui ?", answers: [] },
        { id: 4, prompt: "Quand ai-je demandé de l’aide aujourd’hui ? Comment ça s’est passé ?", answers: [] },
        { id: 5, prompt: "Quoi de nouveau ai-je appris aujourd’hui ?", answers: [] },
        { id: 6, prompt: "Quelle chose aimerais-je répéter demain ?", answers: [] },
        { id: 7, prompt: "Qu’est-ce qui m’a fait rire aujourd’hui ?", answers: [] },
        { id: 8, prompt: "Pour quoi suis-je reconnaissant(e) aujourd’hui ?", answers: [] },
        { id: 9, prompt: "Quel souvenir d’aujourd’hui aimerais-je garder ?", answers: [] },
    ],
    saveButton: "Enregistrer les souvenirs",
    success: "Souvenirs enregistrés avec succès !",
    textFieldPlaceholder: "Entrez un souvenir ici...",
    titleDay: "Aujourd’hui",
    history: "Historique",
...
const german: Language = {
    ...
    questions: [
        ...
        { id: 4, prompt: "Wann habe ich heute um Hilfe gebeten? Wie ist es gelaufen?", answers: [] },
        { id: 5, prompt: "Was Neues habe ich heute gelernt?", answers: [] },
        { id: 6, prompt: "Was möchte ich morgen wiederholen?", answers: [] },
        { id: 7, prompt: "Was hat mich heute zum Lachen gebracht?", answers: [] },
        { id: 8, prompt: "Wofür bin ich heute dankbar?", answers: [] },
        { id: 9, prompt: "Welche Erinnerung von heute möchte ich behalten?", answers: [] },
    ],
...
const japanese: Language = {
    ...
    questions: [
        ...
        { id: 4, prompt: "今日、助けを求めたのはいつですか？ どうでしたか？", answers: [] },
        ...
        { id: 9, prompt: "今日の思い出で、残しておきたいものは何ですか？", answers: [] },
    ],
    saveButton: "思い出を保存",
